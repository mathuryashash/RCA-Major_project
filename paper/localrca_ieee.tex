...
pairs and forbids mechanisms that demonstrably exist. We argue that the
...
pipeline after the statistical gates: of $459$ accepted pairs, $337$ survive,
$122$ ($22.7\%$) are rejected by the map and $79$ ($14.7\%$) by cycle-breaking.
...
a passing test suite of 142 tests. In nearly every case the test asked a
